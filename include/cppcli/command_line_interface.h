...
/** \brief copyright period description */
inline std::string copyright_period()
{
  return "2012";
}

/** \brief copyright owner description */
inline std::string copyright_owner()
{
...
class command_line_parser
{
  ...
  public:
     ...
     **/
    command_line_error error(std::string const& message) const
    {
      return command_line_error(m_interface.m_name, message);
    }
